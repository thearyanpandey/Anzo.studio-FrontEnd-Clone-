...
function Page2() {
  ...
  return (
    <div id="page2" className="bg-white text-black p-40 text-center">
      <h3 className="text-gray-500 text-xl font-sans">
      ...
      <svg className="w-[75vw] mt-10"
        ...
        <div className="absolute left-1/2 -translate-x-1/2 w-[36vw] h-[2px] mt-4 bg-black"></div>
      </div>
    </div>
  );
}
